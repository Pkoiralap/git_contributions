...
url1 = "https://api.github.com/orgs/NASA-IMPACT/repos?per_page=100&page=1"
url2 = "https://api.github.com/orgs/NASA-IMPACT/repos?per_page=100&page=2"
...
contributors_headers = {
    ...
    "Host": 'github.com',
    "Pragma": 'no-cache',
    "Referer": 'https://github.com/NASA-IMPACT/image_labeler/graphs/contributors',
...
def save_contributors(continue_from=0, sleep_time=10):
    ...
    for repo in tqdm(all_repos[continue_from:]):
        if repo["fork"]:
            continue
        try:
            url = "https://github.com/NASA-IMPACT/{}/graphs/contributors-data".format(repo["name"])
            contributors_headers["Referer"] = 'https://github.com/NASA-IMPACT/{}/graphs/contributors'.format(repo["name"])
